...
def send_msg_to_user(client: WebClient, request_form: dict, msg: str, blocks=None) -> None:
    """
...
def send_msg_to_chat(client: WebClient, request_form: dict, msg: str, blocks=None) -> None:
    """
